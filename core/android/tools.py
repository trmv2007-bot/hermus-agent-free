...
def register_android_tools(registry, tool=None) -> None:
    ...
    def android_permission_status() -> dict[str, Any]:
        return {"ok": True, "consent": {c: perms.is_consented(c) for c in OP_CLASSES}, "allowed_ops": perms.allowed_ops()}
    ...
    registry.register(
        "android_back",
        android_back,
        _tool_def("android_back", "Send BACK keyevent. Requires 'ui_control' consent.", {"type": "object", "properties": {}}),
        source="core.android",
    )
    ...
    registry.register(
        ...
        _tool_def(
            ...
            {"type": "object", "properties": {"op_class": {"type": "string"}}, "required": ["op_class"]},
        ),
        source="core.android",
    )
    ...
    registry.register(
        ...
        android_permission_status,
        _tool_def(
            "android_permission_status", "Show current consent and allowed-ops state.", {"type": "object", "properties": {}}
        ),
        source="core.android",
    )
    ...
    registry.register(
        ...
        _tool_def(
            ...
            {"type": "object", "properties": {"ops": {"type": "array", "items": {"type": "string"}}}, "required": ["ops"]},
        ),
        source="core.android",
    )
