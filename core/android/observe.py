...
def _node_label(node: dict[str, Any]) -> str:
    return node.get("text") or node.get("desc") or node.get("contentDescription") or node.get("id") or ""


def build_observation(
    ui_tree: dict[str, Any], *, screen: dict[str, Any] | None = None, screenshot_ref: str | None = None
) -> dict[str, Any]:
...
def _summary(buttons: list, fields: list, texts: list, package: str | None) -> str:
