...
def test_token_counter():
    from core.token_counter import count_tokens, token_counter

    text = "Hello, this is a test message about Python async programming."
    count = count_tokens(text)
    print(f"✅ Token count for '{text[:30]}...': {count} tokens")

    messages = [{"role": "user", "content": "What is Python async?"}, {"role": "assistant", "content": "Python async is..."}]
