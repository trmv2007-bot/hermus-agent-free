"""14-social-media-agent - free clone of the original crewai agent.
...
SPEC = CLONES["14_social_media_agent"]
...
if __name__ == "__main__":
    print(run("test query for 14-social-media-agent")["report"][:500])
