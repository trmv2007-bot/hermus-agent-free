...
description: Generates platform-optimized content for Twitter, LinkedIn, and Instagram - Use when user says 14 social media agent or needs marketing agent - Framework: crewai - From 500 AI Agents Projects (36k stars) - 14-social-media-agent
---

# social-media-content-agent - 14_social_media_agent
...
**Tags:** crewai, marketing, 500-agents, free

## What it does

Generates platform-optimized content for Twitter, LinkedIn, and Instagram

Original agent from 500-AI-Agents-Projects collection - 14-social-media-agent:
...
```bash
cd agents/14-social-media-agent
...
```
/14_social_media_agent
```

Or:

```
You: I need 14 social media agent
Hermus: [Tool] skill_use({"name": "14_social_media_agent"})
```
...
- "marketing agent"
- "I need Generates platform-optimized content for Twitter, "
...
This agent belongs to marketing industry. Other industries in collection:
...
If you want original exact code, clone: https://github.com/ashishpatel26/500-AI-Agents-Projects/tree/main/14-social-media-agent
