"""12-travel-planner-agent - free clone of the original crewai agent.
...
SPEC = CLONES["12_travel_planner_agent"]
...
if __name__ == "__main__":
    print(run("test query for 12-travel-planner-agent")["report"][:500])
