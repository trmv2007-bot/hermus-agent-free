...
description: Multi-agent CrewAI system creating personalized travel itineraries with budget planning - Use when user says 12 travel planner agent or needs travel agent - Framework: crewai - From 500 AI Agents Projects (36k stars) - 12-travel-planner-agent
---

# travel-planner-agent - 12_travel_planner_agent
...
**Tags:** crewai, travel, 500-agents, free

## What it does

Multi-agent CrewAI system creating personalized travel itineraries with budget planning

Original agent from 500-AI-Agents-Projects collection - 12-travel-planner-agent:
...
```bash
cd agents/12-travel-planner-agent
...
```
/12_travel_planner_agent
```

Or:

```
You: I need 12 travel planner agent
Hermus: [Tool] skill_use({"name": "12_travel_planner_agent"})
```
...
- "travel agent"
- "I need Multi-agent CrewAI system creating personalized tr"
...
This agent belongs to travel industry. Other industries in collection:
...
If you want original exact code, clone: https://github.com/ashishpatel26/500-AI-Agents-Projects/tree/main/12-travel-planner-agent
