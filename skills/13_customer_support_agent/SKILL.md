...
description: RAG-powered customer support agent with escalation routing using LangGraph - Use when user says 13 customer support agent or needs customer-service agent - Framework: langgraph - From 500 AI Agents Projects (36k stars) - 13-customer-support-agent
---

# customer-support-agent - 13_customer_support_agent
...
**Tags:** langgraph, customer-service, 500-agents, free

## What it does

RAG-powered customer support agent with escalation routing using LangGraph

Original agent from 500-AI-Agents-Projects collection - 13-customer-support-agent:
...
```bash
cd agents/13-customer-support-agent
...
```
/13_customer_support_agent
```

Or:

```
You: I need 13 customer support agent
Hermus: [Tool] skill_use({"name": "13_customer_support_agent"})
```
...
- "I need RAG-powered customer support agent with escalation"
...
This agent belongs to customer-service industry. Other industries in collection:
...
If you want original exact code, clone: https://github.com/ashishpatel26/500-AI-Agents-Projects/tree/main/13-customer-support-agent
