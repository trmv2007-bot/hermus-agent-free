...
description: Generates README and docstrings for Python modules - Use when user says 16 documentation writer or needs software-development agent - Framework: langchain - From 500 AI Agents Projects (36k stars) - 16-documentation-writer
---

# documentation-writer-agent - 16_documentation_writer
...
Original agent from 500-AI-Agents-Projects collection - 16-documentation-writer:
...
```bash
cd agents/16-documentation-writer
...
```
/16_documentation_writer
```

Or:

```
You: I need 16 documentation writer
Hermus: [Tool] skill_use({"name": "16_documentation_writer"})
```
...
- "I need Generates README and docstrings for Python modules"
...
If you want original exact code, clone: https://github.com/ashishpatel26/500-AI-Agents-Projects/tree/main/16-documentation-writer
