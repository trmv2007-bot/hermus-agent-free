"""20-multi-agent-debate - free clone of the original langchain agent.
...
SPEC = CLONES["20_multi_agent_debate"]
...
if __name__ == "__main__":
    print(run("test query for 20-multi-agent-debate")["report"][:500])
