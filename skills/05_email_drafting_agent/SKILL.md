...
description: Two-agent CrewAI system that drafts professional emails from context - Use when user says 05 email drafting agent or needs communication agent - Framework: crewai - From 500 AI Agents Projects (36k stars) - 05-email-drafting-agent
---

# email-drafting-agent - 05_email_drafting_agent
...
**Tags:** crewai, communication, 500-agents, free

## What it does

Two-agent CrewAI system that drafts professional emails from context

Original agent from 500-AI-Agents-Projects collection - 05-email-drafting-agent:
...
```bash
cd agents/05-email-drafting-agent
...
```
You: I need 05 email drafting agent
Hermus: [Tool] skill_use({"name": "05_email_drafting_agent"})
```
...
- "communication agent"
- "I need Two-agent CrewAI system that drafts professional e"
...
This agent belongs to communication industry. Other industries in collection:
...
If you want original exact code, clone: https://github.com/ashishpatel26/500-AI-Agents-Projects/tree/main/05-email-drafting-agent
