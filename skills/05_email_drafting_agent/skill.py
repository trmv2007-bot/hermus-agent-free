"""05-email-drafting-agent - free clone of the original crewai agent.
...
SPEC = CLONES["05_email_drafting_agent"]
...
if __name__ == "__main__":
    print(run("test query for 05-email-drafting-agent")["report"][:500])
