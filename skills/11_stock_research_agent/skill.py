"""11-stock-research-agent - free clone of the original langchain agent.
...
SPEC = CLONES["11_stock_research_agent"]
...
if __name__ == "__main__":
    print(run("test query for 11-stock-research-agent")["report"][:500])
