...
description: Reviews code for bugs, security issues, performance, and style violations - Use when user says 02 code review agent or needs software-development agent - Framework: langchain - From 500 AI Agents Projects (36k stars) - 02-code-review-agent
---

# code-review-agent - 02_code_review_agent
...
Original agent from 500-AI-Agents-Projects collection - 02-code-review-agent:
...
```bash
cd agents/02-code-review-agent
...
```
You: I need 02 code review agent
Hermus: [Tool] skill_use({"name": "02_code_review_agent"})
```
...
- "I need Reviews code for bugs, security issues, performanc"
...
If you want original exact code, clone: https://github.com/ashishpatel26/500-AI-Agents-Projects/tree/main/02-code-review-agent
