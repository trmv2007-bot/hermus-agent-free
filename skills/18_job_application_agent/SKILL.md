...
description: Generates cover letter, interview prep, and salary range from job description + candidate profile - Use when user says 18 job application agent or needs human-resources agent - Framework: crewai - From 500 AI Agents Projects (36k stars) - 18-job-application-agent
---

# job-application-agent - 18_job_application_agent
...
**Tags:** crewai, human-resources, 500-agents, free

## What it does

Generates cover letter, interview prep, and salary range from job description + candidate profile

Original agent from 500-AI-Agents-Projects collection - 18-job-application-agent:
...
```bash
cd agents/18-job-application-agent
...
```
You: I need 18 job application agent
Hermus: [Tool] skill_use({"name": "18_job_application_agent"})
```
...
- "I need Generates cover letter, interview prep, and salary"
...
If you want original exact code, clone: https://github.com/ashishpatel26/500-AI-Agents-Projects/tree/main/18-job-application-agent
