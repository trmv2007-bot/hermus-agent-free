"""18-job-application-agent - free clone of the original crewai agent.
...
SPEC = CLONES["18_job_application_agent"]
...
if __name__ == "__main__":
    print(run("test query for 18-job-application-agent")["report"][:500])
