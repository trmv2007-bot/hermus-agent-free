...
description: Chat with CSV/Excel data using natural language queries powered by pandas - Use when user says 08 data analysis agent or needs analytics agent - Framework: langchain - From 500 AI Agents Projects (36k stars) - 08-data-analysis-agent
---

# data-analysis-agent - 08_data_analysis_agent

Chat with CSV/Excel data using natural language queries powered by pandas

**Framework:** langchain  
**Industry:** analytics  
**Original:** https://github.com/ashishpatel26/500-AI-Agents-Projects/tree/main/08-data-analysis-agent  
**Tags:** langchain, analytics, 500-agents, free

## What it does

Chat with CSV/Excel data using natural language queries powered by pandas

Original agent from 500-AI-Agents-Projects collection - 08-data-analysis-agent:
...
```bash
cd agents/08-data-analysis-agent
...
```
/08_data_analysis_agent
```

Or:

```
You: I need 08 data analysis agent
Hermus: [Tool] skill_use({"name": "08_data_analysis_agent"})
```
...
- "analytics agent"
- "I need Chat with CSV/Excel data using natural language qu"
...
This agent belongs to analytics industry. Other industries in collection:
...
If you want original exact code, clone: https://github.com/ashishpatel26/500-AI-Agents-Projects/tree/main/08-data-analysis-agent
