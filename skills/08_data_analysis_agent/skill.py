"""08-data-analysis-agent - free clone of the original langchain agent.
...
SPEC = CLONES["08_data_analysis_agent"]
...
if __name__ == "__main__":
    print(run("test query for 08-data-analysis-agent")["report"][:500])
