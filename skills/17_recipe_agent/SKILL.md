...
description: Suggests recipes from available ingredients with instructions and nutrition info - Use when user says 17 recipe agent or needs food agent - Framework: langchain - From 500 AI Agents Projects (36k stars) - 17-recipe-agent
---

# recipe-recommendation-agent - 17_recipe_agent
...
**Tags:** langchain, food, 500-agents, free

## What it does

Suggests recipes from available ingredients with instructions and nutrition info

Original agent from 500-AI-Agents-Projects collection - 17-recipe-agent:
...
```
You: I need 17 recipe agent
Hermus: [Tool] skill_use({"name": "17_recipe_agent"})
```
...
- "17 recipe agent"
- "food agent"
- "I need Suggests recipes from available ingredients with i"
...
This agent belongs to food industry. Other industries in collection:
...
If you want original exact code, clone: https://github.com/ashishpatel26/500-AI-Agents-Projects/tree/main/17-recipe-agent
