"""09-resume-parser-agent - free clone of the original langchain agent.
...
SPEC = CLONES["09_resume_parser_agent"]
...
if __name__ == "__main__":
    print(run("test query for 09-resume-parser-agent")["report"][:500])
