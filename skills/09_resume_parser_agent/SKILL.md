...
description: Parses resumes to structured JSON and scores candidate fit against job descriptions - Use when user says 09 resume parser agent or needs human-resources agent - Framework: langchain - From 500 AI Agents Projects (36k stars) - 09-resume-parser-agent
---

# resume-parser-agent - 09_resume_parser_agent
...
**Tags:** langchain, human-resources, 500-agents, free

## What it does

Parses resumes to structured JSON and scores candidate fit against job descriptions

Original agent from 500-AI-Agents-Projects collection - 09-resume-parser-agent:
...
```bash
cd agents/09-resume-parser-agent
...
```
You: I need 09 resume parser agent
Hermus: [Tool] skill_use({"name": "09_resume_parser_agent"})
```

## When to use

Use this skill when user says:
- "09 resume parser agent"
- "human-resources agent"
- "I need Parses resumes to structured JSON and scores candi"
...
This agent belongs to human-resources industry. Other industries in collection:
...
If you want original exact code, clone: https://github.com/ashishpatel26/500-AI-Agents-Projects/tree/main/09-resume-parser-agent
