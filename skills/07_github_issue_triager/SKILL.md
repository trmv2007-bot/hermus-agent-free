...
description: Automatically triages GitHub issues with severity, category, and routing recommendations - Use when user says 07 github issue triager or needs software-development agent - Framework: langchain - From 500 AI Agents Projects (36k stars) - 07-github-issue-triager
---

# github-issue-triager - 07_github_issue_triager
...
Original agent from 500-AI-Agents-Projects collection - 07-github-issue-triager:
...
```bash
cd agents/07-github-issue-triager
...
```
/07_github_issue_triager
```

Or:

```
You: I need 07 github issue triager
Hermus: [Tool] skill_use({"name": "07_github_issue_triager"})
```

## When to use

Use this skill when user says:
- "07 github issue triager"
- "software-development agent"
- "I need Automatically triages GitHub issues with severity,"
...
If you want original exact code, clone: https://github.com/ashishpatel26/500-AI-Agents-Projects/tree/main/07-github-issue-triager
