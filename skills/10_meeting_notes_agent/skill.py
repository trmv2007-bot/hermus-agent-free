"""10-meeting-notes-agent - free clone of the original langchain agent.
...
SPEC = CLONES["10_meeting_notes_agent"]
...
if __name__ == "__main__":
    print(run("test query for 10-meeting-notes-agent")["report"][:500])
