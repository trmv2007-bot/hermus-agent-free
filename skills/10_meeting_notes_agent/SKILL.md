...
description: Converts meeting transcripts into structured notes with action items and decisions - Use when user says 10 meeting notes agent or needs productivity agent - Framework: langchain - From 500 AI Agents Projects (36k stars) - 10-meeting-notes-agent
---

# meeting-notes-agent - 10_meeting_notes_agent
...
**Tags:** langchain, productivity, 500-agents, free

## What it does

Converts meeting transcripts into structured notes with action items and decisions

Original agent from 500-AI-Agents-Projects collection - 10-meeting-notes-agent:
...
```
/10_meeting_notes_agent
```

Or:

```
You: I need 10 meeting notes agent
Hermus: [Tool] skill_use({"name": "10_meeting_notes_agent"})
```
...
- "productivity agent"
- "I need Converts meeting transcripts into structured notes"
...
This agent belongs to productivity industry. Other industries in collection:
...
If you want original exact code, clone: https://github.com/ashishpatel26/500-AI-Agents-Projects/tree/main/10-meeting-notes-agent
