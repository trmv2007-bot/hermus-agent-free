"""06-news-summarizer-agent - free clone of the original langchain agent.
...
SPEC = CLONES["06_news_summarizer_agent"]
...
if __name__ == "__main__":
    print(run("test query for 06-news-summarizer-agent")["report"][:500])
