...
description: Fetches news on any topic and produces a structured briefing with key themes - Use when user says 06 news summarizer agent or needs media agent - Framework: langchain - From 500 AI Agents Projects (36k stars) - 06-news-summarizer-agent
---

# news-summarizer-agent - 06_news_summarizer_agent
...
**Tags:** langchain, media, 500-agents, free

## What it does

Fetches news on any topic and produces a structured briefing with key themes

Original agent from 500-AI-Agents-Projects collection - 06-news-summarizer-agent:
...
```bash
cd agents/06-news-summarizer-agent
...
```
/06_news_summarizer_agent
```

Or:

```
You: I need 06 news summarizer agent
Hermus: [Tool] skill_use({"name": "06_news_summarizer_agent"})
```

## When to use

Use this skill when user says:
- "06 news summarizer agent"
- "media agent"
- "I need Fetches news on any topic and produces a structure"
...
This agent belongs to media industry. Other industries in collection:
...
If you want original exact code, clone: https://github.com/ashishpatel26/500-AI-Agents-Projects/tree/main/06-news-summarizer-agent
