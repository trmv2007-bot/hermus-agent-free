"""15-unit-test-generator - free clone of the original langchain agent.
...
SPEC = CLONES["15_unit_test_generator"]
...
if __name__ == "__main__":
    print(run("test query for 15-unit-test-generator")["report"][:500])
